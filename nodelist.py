...
class PriorityQueue(List):
    def __swap(self, p, q):
        ...
        self._nodes[q] = n
        pass# swaps the value of nodes at positions p and q
    ...
    def __shiftUp(self, parent, child):
        ...
        pass # swaps the child and the parent node while the parent's heuristic is greater that the child's heuristic
    ...
    def __shiftDown(self, parent):
        ...
        if left_child <= last_child:
            if right_child <= last_child:
                ...
                if self._nodes[parent].heuristic > self._nodes[left_child].heuristic:
                    self.__swap(parent, left_child) 
        pass# swaps the parent with minimum of its left and right child
    ...
    def remove(self):
        if not self.empty():
            ...
            return root_node
        pass# removes the node with the minimum key (heuristic)